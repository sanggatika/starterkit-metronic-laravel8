<div class="toolbar d-flex align-items-stretch">
    ...
    <div
        ...
        <div class="d-flex align-items-stretch overflow-auto pt-3 pt-lg-0">
            ...
            <!--begin::Action wrapper-->
            <div class="d-flex align-items-center">
                <button class="btn btn-primary me-5 p-2" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-400px py-3"
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content text-muted pb-2 px-3 fs-7 text-uppercase">Notifikasi Informasi</div>
                    </div>
                    <!--end::Heading-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">

<div class="mb-0" id="home">
    ...
    <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg"
        ...
        <div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
            <!--begin::Heading-->
            <div class="text-center mb-2 py-2 py-lg-2">
                <!--begin::Title-->
                <h1 class="text-white lh-base fw-bold fs-2x fs-lg-3x mb-2">
                    <span
                        style="background: linear-gradient(to right, #12CE5D 0%, #FFD80C 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
                        <span id="kt_landing_hero_text">Starterkit Metronic 8</span>
                    </span>
                </h1>
                <h1 class="text-white lh-base fw-bold fs-1x fs-lg-2x">
                    Sistem Retribusi Permintaan Pemeriksaan Sampel 
                </h1>
                <h1 class="text-white lh-base fw-bold fs-1x fs-lg-2x">
                    Pemerintah Kabupaten Karawang 
                </h1>
                <img src="{{ asset('images/A03.png') }}" class="img-fluid" style="max-height: 350px;" alt="bupati_logo">
                <!--end::Title-->
